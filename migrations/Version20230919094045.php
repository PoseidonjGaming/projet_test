 ...
 */
final class Version20230919094045 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE category_series (category_id INT NOT NULL, series_id INT NOT NULL, INDEX IDX_35F8CB5612469DE2 (category_id), INDEX IDX_35F8CB565278319C (series_id), PRIMARY KEY(category_id, series_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
